...
class DataProcessor:
    """
    Class for downloading and processing market data
    """
    ...
    def _process_data(self, data):
        ...
        # Convert column names to title case (Open, High, Low, Close)
        data.columns = [col.title() if col != 'date' else 'Date' for col in data.columns]
