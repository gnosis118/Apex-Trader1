...
if not st.session_state.data_loaded:
    ...
    - Storage system for market data and strategies
    """)
    ...
    # Database Tab (renamed to Storage)
        ...
        with tab2:
            ...
            if maintenance_option == "Information":
                ...
                Data is stored in the 'data' directory with subdirectories for each type.
                """)
            ...
            st.markdown("""
            ---
            **Note:** This is a simple file-based storage system. For more advanced operations,
            use the storage management functions in the `file_storage.py` module.
            """)